...
export const ChatModal = memo(({ isOpen, onClose }: ChatModalProps) => {
  ...
  return (
    <>
      ...
      {/* 模态框 */}
      <div
        className="fixed inset-4 md:inset-8 lg:inset-12 bg-white rounded-2xl shadow-2xl z-50 flex flex-col overflow-hidden animate-in zoom-in-95 fade-in duration-200"
      >
        {/* 头部 */}
